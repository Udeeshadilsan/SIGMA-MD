...
global.owner = process.env.OWNER_NUMBER  || '94743275540' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "94743275540" ;          // DON'T REMOVE
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '03_07_2024_SIGMA_MD_Fymm74gL_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'sɪɢᴍᴀ-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𝙳 𝙸 𝙽 𝚄  𝙾𝙵𝙲`, // ADD YOUR NAME
